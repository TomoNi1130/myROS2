...
#ifndef STUDY_INTERFACE__MSG__DETAIL__CLOUD__TYPE_SUPPORT_H_
#define STUDY_INTERFACE__MSG__DETAIL__CLOUD__TYPE_SUPPORT_H_
...
#endif  // STUDY_INTERFACE__MSG__DETAIL__CLOUD__TYPE_SUPPORT_H_
