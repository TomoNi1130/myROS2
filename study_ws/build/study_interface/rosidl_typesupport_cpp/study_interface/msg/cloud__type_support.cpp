...
static const _Cloud_type_support_symbol_names_t _Cloud_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, study_interface, msg, Cloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, study_interface, msg, Cloud)),
  }
};
...
{
  return &::study_interface::msg::rosidl_typesupport_cpp::Cloud_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, study_interface, msg, Cloud)() {
  return get_message_type_support_handle<study_interface::msg::Cloud>();
}
